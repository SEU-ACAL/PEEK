...
{
  uint64_t set_mapper;
                  /*0b11110000*/                    /*0b1001 0000 0000 0000 0000*/
  set_mapper = ((inst_type & 0xff)<<4) | ((ses_receiving_inst & 0xFFFF)<<16) | 0x03; /*0b1001 0000 0000 1111 0011*/
...
static inline void start_tracing(){
  ROCC_INSTRUCTION(1, 0x99);
}

static inline void end_tracing(){
  ROCC_INSTRUCTION(1, 0x98);
}
