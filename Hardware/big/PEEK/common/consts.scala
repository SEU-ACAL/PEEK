...
package boom.peek.common.constants
...
//val uopSRET = 40.U(UOPC_SZ.W)
  ...
  def NullMicroOp()(implicit p: Parameters): boom.peek.common.MicroOp = {
    val uop = Wire(new boom.peek.common.MicroOp)
    ...
    val cs = Wire(new boom.peek.common.CtrlSignals())
...
trait RISCVConstants
{
  ...
  def GetCfiType(inst: UInt)(implicit p: Parameters): UInt = {
    val bdecode = Module(new boom.peek.exu.BranchDecode)
