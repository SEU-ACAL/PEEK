...
import boom.peek.lsu.{BoomNonBlockingDCache, LSU, LSUCoreIO}
import boom.peek.common.{BoomTileParams, MicroOp, BoomCoreParams, BoomModule}
...
class BoomLSUShim(implicit p: Parameters) extends BoomModule()(p)
  ...
  io.lsu.brupdate.b1 := (0.U).asTypeOf(new boom.peek.exu.BrUpdateMasks)
