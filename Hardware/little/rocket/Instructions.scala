...
object CSRshadowsindex{
  ...
  def getindex(addr: UInt): UInt = {
    MuxLookup(addr, 0.U)(Seq(
      CSRshadows.mstatus.U -> mstatus.U,
      CSRshadows.mie.U -> mie.U,
      CSRshadows.mtvec.U -> mtvec.U,
      CSRshadows.mscratch.U -> mscratch.U,
      CSRshadows.mepc.U -> mepc.U,
      CSRshadows.mip.U -> mip.U,
      CSRshadows.sstatus.U -> sstatus.U,
      CSRshadows.sie.U -> sie.U,
      CSRshadows.sscratch.U -> sscratch.U,
      CSRshadows.sepc.U -> sepc.U,
      CSRshadows.scause.U -> scause.U,
      CSRshadows.stval.U -> stval.U,
      CSRshadows.sip.U -> sip.U
    ))
  }
}
